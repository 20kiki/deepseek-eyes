...
| 模型 | 适用场景 | 精度 | 速度 |
| :--- | :--- | :--- | :--- |
| `qwen3-vl-plus` | **精度优先。** 照片、图表、小字、复杂场景。能识别艺术品作者、隐藏文字。 | ★★★ | ★★ |
| `qwen3.6-plus`（默认）| **日常通用。** 普通照片、简单截图。 | ★★ | ★★ |
| `qwen3.6-flash` | **仅快速预览。** 可能认错颜色、遗漏细节。 | ★ | ★★★ |
...
> **推荐：** 精度场景用 `--model qwen3-vl-plus --high-res`，日常用 `qwen3.6-plus --high-res`，flash 不适合需要准确度的场景。
